...
const Header = ({ isSidebarCollapsed, toggleSidebar, onNavigate }) => {
  ...
  return (
    <header className={`bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between shadow-sm fixed top-0 right-0 z-20 transition-all duration-300 ${isSidebarCollapsed ? 'left-16' : 'left-72'
      }`}>
